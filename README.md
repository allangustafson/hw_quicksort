...
3. Click the 3 dots next to Department column. Select "contains" and type your department.
   
   Click the 3 dots next to State column. Uncheck "retired" and "missing"

4. In top right, export and select csv.

5. Rename the csv to `input_hw.csv` and place it in the directory you cloned from here alongside the python script.
